...
<div class="container">
	...
	<div ng-app="myApp" ng-controller="productCtrl" ng-init="test='${id}'">
		<p>
    ...
    <thead>
      <tr>
       <th >ID</th>
				...
				<th ng-click=""src/main/webapp/WEB-INF/spring-dispatcher-servlet.xml"orderByMe('band)">brand</th>
				<th ng-click="orderByMe('country')">price</th>
			</tr>
			<tr ng-repeat="x in myData | orderBy:myOrderBy | filter:{id:test}">
				<td>{{x.id}}</td>
				<td>{{x.productname}}</td>
				<td>{{x.brand}}</td>
				<td>{{x.price}}</td>
